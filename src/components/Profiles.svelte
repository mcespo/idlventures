  ...
  <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 lg:py-24">
    <div class="space-y-12">
      <div class="space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 lg:max-w-5xl">
        <h2 class="mt-2 text-4xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">IDL Team</h2>
        <p class="mt-8 text-2xl text-gray-500">Team with international recognition and extensive executive expertise in internationalization, deep tech investments and development.</p>
