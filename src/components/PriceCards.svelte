<section class="bg-gray-50">
	<div class="relative bg-indigo-600">
		...
		>
			...
			<div
				aria-hidden="true"
				class="hidden absolute top-4 bottom-6 left-8 right-8 inset-0 bg-idl-gray-medium rounded-tl-lg rounded-tr-lg lg:block"
			/>
			<div class="relative space-y-6 lg:space-y-0 lg:grid lg:grid-cols-3">
				<div
					class="bg-idl-gray-medium lg:bg-transparent pt-6 px-6 pb-3 rounded-lg lg:px-8 lg:pt-12"
				>
					<div>
				...
				<div
					class="bg-white ring-2 ring-indigo-700 shadow-md pt-6 px-6 pb-3 rounded-lg lg:px-8 lg:pt-12"
				>
					<div>
